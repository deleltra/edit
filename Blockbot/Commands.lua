...
Commands["update"] = {
    ...
    ["Function"] = function(Player, Args)
        ...
        CommandsTable = getgenv().BlockateBot_Settings.DevMode and loadstring(readfile(getgenv().BlockateBot_Settings.Commands_FilePath))() or loadstring(game:HttpGet("https://raw.githubusercontent.com/deleltra/Remaked-choke/main/Commands.lua"))()
    end
}
...
Commands["stop"] = {
    ...
    ["Function"] = function(Player, Args)
        ...
        sayMessage("Stopped. No Longer Responding.", true)
    end
}
